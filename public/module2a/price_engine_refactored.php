    ...
    <div class="receipt">
        ...
        <?php
            ...
            if ($color == 'Sunset Orange' || $color == 'Ocean Blue') {
                $finalPrice += 2.00;
                $details .= "<li>Premium Color Fee ({$color}): <span>+$2.00</span></li>";
            }
            ...
            /*
            MY DEBUGGING LOG:
            Problem: In Part A I kept using === instead of == and other similar sytax errors
            Solution: paying closer attention to what I am doing.
            */
